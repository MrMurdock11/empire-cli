...
export class Store {
	...
	public get keysFileContent(): string { return this._keysFileContent; }
	public set keysFileContent(value: string) { this._keysFileContent = value; }

	private _actionsFileContent: string = String();
	public get actionsFileContent(): string { return this._actionsFileContent; }
	public set actionsFileContent(value: string) { this._actionsFileContent = value; }

	private _actionsTypeFileContent: string = String();
	public get actionsTypeFileContent(): string { return this._actionsTypeFileContent; }
	public set actionsTypeFileContent(value: string) { this._actionsTypeFileContent = value; }

	private _reducersFileContent: string = String();
	public get reducersFileContent(): string { return this._reducersFileContent; }
	public set reducersFileContent(value: string) { this._reducersFileContent = value; }

	private _reducersTestFileContent: string = String();
	public get reducersTestFileContent(): string { return this._reducersTestFileContent; }
	public set reducersTestFileContent(value: string) { this._reducersTestFileContent = value; }

	private _stateFileContent: string = String();
	public get stateFileContent(): string { return this._stateFileContent; }
	public set stateFileContent(value: string) { this._stateFileContent = value; }
